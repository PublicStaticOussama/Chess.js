class ChessGame {
    ...
    /**
     * @returns {"capture" | "move" | "invalid" | "castle_kingside" | "castle_queenside", | "black_promotion" | "white_promotion" | "black_promotion_capture" | "white_promotion_capture"}
     */
    ...
    updateMoveMask(piece_symbol, i, j, mask=this.cursor_move_mask, ignore_king=false, xray_through_king=false) {
        switch(piece_symbol) {
            case "p":
            case "P":
